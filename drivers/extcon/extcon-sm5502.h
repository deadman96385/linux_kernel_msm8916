...
/* SM5703-specific registers and status bits */
#define SM5703_REG_VBUSINVALID			0x1d
#define SM5703_REG_CHGPUMP_SET			0x3a
#define SM5703_REG_VBUSIN_VALID_MASK		BIT(1)
#define SM5703_REG_DEV_TYPE3_NON_STANDARD_MASK	BIT(2)
#define SM5703_REG_DEV_TYPE3_U200_CHG_MASK	BIT(6)
...
enum sm5703_irq {
	/* INT1 */
	SM5703_IRQ_INT1_ATTACH,
	SM5703_IRQ_INT1_DETACH,
	SM5703_IRQ_INT1_KP,
	SM5703_IRQ_INT1_LKP,
	SM5703_IRQ_INT1_LKR,
	SM5703_IRQ_INT1_OVP_ENABLE,
	SM5703_IRQ_INT1_RESERVED,
	SM5703_IRQ_INT1_OVP_DISABLE,

	/* INT2 */
	SM5703_IRQ_INT2_VBUS_OFF,
	SM5703_IRQ_INT2_RESERVED_ATTACH,
	SM5703_IRQ_INT2_ADC_CHANGE,
	SM5703_IRQ_INT2_STUCK_KEY,
	SM5703_IRQ_INT2_STUCK_KEY_RCV,
	SM5703_IRQ_INT2_MHL,
	SM5703_IRQ_INT2_RID_CHARGER,
	SM5703_IRQ_INT2_VBUSDET_ON,

	SM5703_IRQ_NUM,
};

#define SM5703_IRQ_INT1_ATTACH_MASK		BIT(0)
#define SM5703_IRQ_INT1_DETACH_MASK		BIT(1)
#define SM5703_IRQ_INT1_KP_MASK			BIT(2)
#define SM5703_IRQ_INT1_LKP_MASK		BIT(3)
#define SM5703_IRQ_INT1_LKR_MASK		BIT(4)
#define SM5703_IRQ_INT1_OVP_ENABLE_MASK		BIT(5)
#define SM5703_IRQ_INT1_RESERVED_MASK		BIT(6)
#define SM5703_IRQ_INT1_OVP_DISABLE_MASK	BIT(7)
#define SM5703_IRQ_INT2_VBUS_OFF_MASK		BIT(0)
#define SM5703_IRQ_INT2_RESERVED_ATTACH_MASK	BIT(1)
#define SM5703_IRQ_INT2_ADC_CHANGE_MASK		BIT(2)
#define SM5703_IRQ_INT2_STUCK_KEY_MASK		BIT(3)
#define SM5703_IRQ_INT2_STUCK_KEY_RCV_MASK	BIT(4)
#define SM5703_IRQ_INT2_MHL_MASK		BIT(5)
#define SM5703_IRQ_INT2_RID_CHARGER_MASK	BIT(6)
#define SM5703_IRQ_INT2_VBUSDET_ON_MASK		BIT(7)
